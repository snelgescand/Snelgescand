    ...
    items: [
      {
        ...
        opties: [
          ...
          { waarde: 'all-electric-wp', label: 'All-electric warmtepomp (lucht/water of bodem)', score: 95 },
      ...
      {
        id: 'aanvullende-verwarming',
        label: 'Aanvullende verwarming / koeling',
        uitleg: 'Naast het hoofdsysteem — denk aan airco\'s (lucht/lucht-warmtepompen), straalkachels in de bestuurskamer of WTW-ventilatie met verwarming.',
        opties: [
          { waarde: 'geen', label: 'Geen aanvullende verwarming', score: 50 },
          { waarde: 'airco-lucht-lucht', label: 'Airco\'s / lucht-lucht warmtepompen (split-units)', score: 70 },
          { waarde: 'straalkachels-elek', label: 'Elektrische straalkachels (lokaal bijverwarmen)', score: 20 },
          { waarde: 'straalkachels-gas', label: 'Gas-straalkachels in de hal/zaal', score: 10 },
          { waarde: 'infrarood', label: 'Infraroodpanelen', score: 55 },
          { waarde: 'vloerverwarming-elek', label: 'Elektrische vloerverwarming (lokaal)', score: 40 },
          { waarde: 'wtw-met-verwarming', label: 'WTW-ventilatie met naverwarming', score: 80 },
          { waarde: 'overig', label: 'Anders (specificeer in notitie)', score: 50 },
          { waarde: 'onbekend', label: 'Onbekend', score: 50 },
        ],
      },
      {
  ...
  // ============================================================
  {
    ...
    items: [
      ...
      },
      {
        ...
        uitleg: 'Bijvoorbeeld: dak vernieuwd, kleedkamers gerenoveerd, kozijnen vervangen. Selecteer en licht toe in de notitie.',
        opties: [
          { waarde: 'geen', label: 'Geen recente werkzaamheden', score: 50 },
          { waarde: 'dak-vernieuwd', label: 'Dak vernieuwd', score: 80 },
          { waarde: 'kozijnen-vervangen', label: 'Kozijnen / glas vervangen', score: 80 },
          { waarde: 'kleedkamers-gerenoveerd', label: 'Kleedkamers gerenoveerd', score: 70 },
          { waarde: 'kantine-verbouwd', label: 'Kantine verbouwd', score: 70 },
          { waarde: 'installatie-vernieuwd', label: 'CV / installatie vervangen', score: 75 },
          { waarde: 'meerdere', label: 'Meerdere werkzaamheden (zet in notitie)', score: 75 },
          { waarde: 'overig', label: 'Anders (specificeer in notitie)', score: 60 },
        ],
      },
      {
        id: 'klachten-gebruikers',
        label: 'Bekende klachten van gebruikers',
        uitleg: 'Wat hoor je van bestuur, leden of beheerders over het gebouw? Belangrijk vertrekpunt voor advies.',
        opties: [
          { waarde: 'geen', label: 'Geen klachten', score: 80 },
          { waarde: 'koud-winter', label: 'Koud in winter (kleedkamers, kantine)', score: 30 },
          { waarde: 'warm-zomer', label: 'Te warm in zomer (oververhitting)', score: 35 },
          { waarde: 'vocht-tocht', label: 'Vocht- of tochtproblemen', score: 25 },
          { waarde: 'warm-water', label: 'Warm water raakt op tijdens piek', score: 40 },
          { waarde: 'verlichting', label: 'Slechte verlichting (donker, flikkerend)', score: 35 },
          { waarde: 'meerdere', label: 'Meerdere klachten (zet in notitie)', score: 25 },
          { waarde: 'overig', label: 'Anders (specificeer in notitie)', score: 50 },
        ],
      },
      {
        ...
        opties: [
          ...
          { waarde: 'mjop', label: 'In meerjarig onderhoudsplan opgenomen', score: 80 },
          { waarde: 'subsidie-aangevraagd', label: 'Subsidie al aangevraagd', score: 85 },
          { waarde: 'offerte', label: 'Offerte(s) al binnen', score: 90 },
          { waarde: 'overig', label: 'Anders (specificeer in notitie)', score: 60 },
        ],
      },
      {
        id: 'vrije-notitie-algemeen',
        label: 'Algemene losse notitie',
        uitleg: 'Vrij tekstveld voor alles wat niet in de andere vragen past. Bv. "dak in 2018 vervangen, ALV bevoegd tot €50k zonder ledenbesluit, contactpersoon liefst per WhatsApp".',
        opties: [
          { waarde: 'geen', label: 'Geen extra notitie', score: 50 },
          { waarde: 'zie-notitie', label: 'Zie notitie hieronder ↓', score: 50 },
        ],
      },
    ],
  },
