    ...
    items: [
      {
        ...
        opties: [
          { waarde: 'geen', label: 'Geen isolatie (Rc < 0,5)', score: 0 },
          { waarde: 'beperkt', label: 'Beperkt (Rc 0,5 – 1,3) — oude bouw', score: 20 },
          { waarde: 'matig', label: 'Matig (Rc 1,3 – 2,5) — jaren 80/90', score: 45 },
          { waarde: 'modern', label: 'Modern (Rc 2,5 – 3,5)', score: 75 },
          { waarde: 'goed', label: 'Goed geïsoleerd (Rc ≥ 3,5)', score: 95 },
      ...
      },
      {
        ...
        opties: [
          { waarde: 'geen-spouw', label: 'Massieve muur zonder isolatie', score: 5 },
          { waarde: 'spouw-leeg', label: 'Spouwmuur, niet gevuld', score: 15 },
          { waarde: 'spouw-gevuld', label: 'Spouwmuur, gevuld (parels/schuim)', score: 65 },
          { waarde: 'na-isolatie', label: 'Voor- of na-isolatie laag aangebracht', score: 80 },
      ...
      },
      {
        ...
        opties: [
          { waarde: 'geen', label: 'Geen vloerisolatie', score: 0 },
          { waarde: 'beperkt', label: 'Beperkt aanwezig (Rc < 2)', score: 30 },
          { waarde: 'goed', label: 'Goed geïsoleerd (Rc ≥ 2,5)', score: 85 },
      ...
      },
      {
        ...
        opties: [
          { waarde: 'enkel', label: 'Enkel glas (overal of grotendeels)', score: 0 },
          { waarde: 'enkel-mix', label: 'Mix van enkel + dubbel', score: 20 },
          { waarde: 'dubbel', label: 'Dubbel glas (gewoon)', score: 40 },
          { waarde: 'hr', label: 'HR-glas', score: 60 },
          { waarde: 'hr-pp', label: 'HR++', score: 85 },
          { waarde: 'triple', label: 'Triple-glas', score: 100 },
          { waarde: 'onbekend', label: 'Onbekend', score: 50 },
        ],
      },
      {
