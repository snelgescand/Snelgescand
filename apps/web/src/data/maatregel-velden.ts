...
export const MAATREGEL_META: Record<string, MaatregelMeta> = {
  ...
  'spouwmuurisolatie': {
    ...
    velden: [
      ...
      { pad: 'stookurenPerJaar', label: 'Stookuren per jaar', type: 'number', eenheid: 'uur', tooltip: 'Hoeveel uur per jaar de ruimte wordt verwarmd. Vuistregel sportclub: oktober t/m april ≈ 5 maanden × 10 uur/dag = ~1500 uur. Voor kantines die alleen avond/weekend: ~800 uur. Voor altijd-open: ~3500 uur.', placeholder: 'bv. 1500' },
  ...
  'wtw': {
    ...
    velden: [
      ...
      { pad: 'stookurenPerJaar', label: 'Draaiuren per jaar', type: 'number', eenheid: 'uur', tooltip: 'Hoeveel uur per jaar de ruimte wordt verwarmd. Vuistregel sportclub: oktober t/m april ≈ 5 maanden × 10 uur/dag = ~1500 uur. Voor kantines die alleen avond/weekend: ~800 uur. Voor altijd-open: ~3500 uur.', placeholder: 'bv. 1500' },
  ...
  'lmnt-warmtepomp': {
    kort: 'Modulair LMNT-systeem. Voor middelgrote clubs, modulair op te schalen in 5 kW-stappen. KAN ook ruimteverwarming doen (lage T 35-50°C) — vink dat hieronder aan als je geen aparte lucht/water-WP wilt.',
    velden: [
      { pad: 'vermogenKw', label: 'Vermogen', type: 'number', eenheid: 'kW',
        tooltip: 'Stappen van 5 kW. 15 kW voor ~120 leden, 30 kW voor 300+ leden. Bij ruimteverwarming-inclusief: 25-50 kW typisch.', placeholder: 'bv. 15' },
      { pad: 'bufferLiters', label: 'Boilervat (buffer)', type: 'number', eenheid: 'liter',
      ...
      { pad: 'inclusiefRuimteverwarming', label: 'Doet de LMNT ook ruimteverwarming?', type: 'select',
        opties: [{ waarde: 'false', label: 'Nee — alleen tapwater' }, { waarde: 'true', label: 'Ja — tapwater + verwarming (vervangt lucht/water-WP)' }],
        tooltip: 'Bij "Ja" vervangt de LMNT ook (deels) de gasketel voor ruimteverwarming. Vereist groter vermogen (25-50 kW) en LT-afgiftesysteem.' },
      { pad: 'extraGasBesparingRuimteverwarmingM3', label: 'Te besparen gas voor verwarming', type: 'number', eenheid: 'm³/jaar',
        tooltip: 'Alleen relevant bij "ja" hierboven. Vuistregel sportclub: ~55% van totaal gasverbruik gaat naar ruimteverwarming. Voor 5.000 m³ totaal → ~2.750 m³.', placeholder: 'bv. 2750' },
      { pad: 'ruimteverwarmingTemperatuurC', label: 'Afgifte-temperatuur verwarming', type: 'number', eenheid: '°C',
        tooltip: 'Bij vloerverwarming 35°C, bij LT-radiatoren 45°C, bij oudere radiatoren 55-60°C (laagste = hoogste SCOP). Default 45°C.' },
    ],
  },
  ...
  'binnenverlichting': {
    ...
    velden: [
      ...
      { pad: 'brandurenPerJaar', label: 'Branduren per jaar', type: 'number', eenheid: 'uur', tooltip: 'Hoeveel uur per jaar de verlichting brandt. Vuistregel: 12u × 250 dagen = 3000 uur. Voor avond-only sportclub: ~1500 uur.', placeholder: 'bv. 1500' },
  ...
  'batterij-uitgebreid': {
    ...
    velden: [
      { pad: 'capaciteitKwh', label: 'Capaciteit accu', type: 'number', eenheid: 'kWh',
        tooltip: 'Bruikbare capaciteit. Voor middelgrote sportclub typisch 30-100 kWh. ⏰ Vuistregel avond-werking: gemiddeld avondverbruik (kW) × gewenste autonomie (uur). Bv. 10 kW × 5 uur = 50 kWh.', placeholder: 'bv. 100' },
      { pad: 'vermogenKw', label: 'Vermogen accu', type: 'number', eenheid: 'kW',
        tooltip: 'Maximaal laad-/ontlaadvermogen. Bepaalt ook hoe goed piekvraag in avonduren wordt opgevangen. Typisch ½ × capaciteit.', placeholder: 'bv. 50' },
      { pad: 'urenAutonomieAvond', label: '🌙 Gewenste autonomie ’s avonds', type: 'number', eenheid: 'uur',
        tooltip: 'Hoeveel uur moet de batterij ’s avonds (na zonsondergang) het verbruik kunnen dekken? Sportclub avondbezetting: typisch 18:00-23:00 = 5 uur. Indicatief — capaciteit + vermogen zijn leidend voor de berekening.', placeholder: 'bv. 5' },
  ...
  'batterij-eenvoudig': {
    ...
    velden: [
      { pad: 'capaciteitKwh', label: 'Capaciteit', type: 'number', eenheid: 'kWh',
        tooltip: 'Bruikbare capaciteit. Voor sportclubs typisch 50-200 kWh. ⏰ Tip voor avond-werking: deel jouw gemiddeld avond­verbruik (kW) op de gewenste autonomie (uur). Bv. 10 kW × 4 uur avond = 40 kWh capaciteit. Vuistregel zelfconsumptie: 1× gemiddeld dagverbruik. Voor EPEX-arbitrage: 2-3× zo groot.', placeholder: 'bv. 100' },
      { pad: 'vermogenKw', label: 'Vermogen', type: 'number', eenheid: 'kW',
        tooltip: 'Maximaal laad-/ontladevermogen. Bepaalt ook hoe snel de batterij in de avond piekvraag kan opvangen. Typisch C-rate 0,5 (vermogen = ½ × capaciteit). 100 kWh batterij = 50 kW vermogen. Voor piekafvlakking sportclub: 25-50 kW prima.', placeholder: 'bv. 30' },
      { pad: 'urenAutonomieAvond', label: '🌙 Gewenste autonomie ’s avonds', type: 'number', eenheid: 'uur',
        tooltip: 'Hoeveel uur moet de batterij ’s avonds (zonder zon) het clubverbruik kunnen dekken? Sportclubs draaien meestal 18:00-23:00 = ~5 uur op vol vermogen. De berekening gebruikt dit alleen indicatief — capaciteit en vermogen zijn leidend.', placeholder: 'bv. 5' },
